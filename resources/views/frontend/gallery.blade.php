    ...
    <section class="ilm-gallery-page">
        <div class="container">
            ...
            <div class="ilm-gallery-switch text-center mb-40">
                <a class="ilm-gallery-switch__link is-active" href="{{ route('gallery') }}" wire:navigate>Images</a>
                <a class="ilm-gallery-switch__link" href="{{ route('videos') }}" wire:navigate>Videos</a>
            </div>
                        ...
                        @empty
                            <div class="col-12">
                                <div class="ilm-empty-state text-center">
                                    ...
                                    <a class="tp-btn ilm-btn-orange" href="{{ route('videos') }}" wire:navigate>Watch Videos</a>
                                </div>
                            </div>
                        @endforelse
                    </div>
