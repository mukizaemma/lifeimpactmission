                    ...
                    <article class="ilm-update-card">
                        ...
                        <div class="ilm-update-card__body">
                            ...
                            <h3 class="ilm-update-card__title">
                                <a href="{{ route('postSingle', $blog->slug) }}" wire:navigate>{{ $blog->title }}</a>
                            </h3>
                            <p class="ilm-update-card__excerpt">
                                {{ Str::limit(strip_tags($blog->body), 110, '...') }}
                            </p>
                            <a class="tp-btn ilm-btn-orange ilm-btn-sm" href="{{ route('postSingle', $blog->slug) }}" wire:navigate>Read More</a>
                        </div>
                    </article>
                </div>
                @empty
