...
@section('content')
        ...
        <div class="tp-breadcrumb__area p-relative fix tp-breadcrumb-height" data-background="{{ asset('storage/images/programs') . $program->image }}" style="height: auto; width: 80%; margin: 0 auto;">
