...
<div class="card-header">
            <a href="{{route('getProjects')}}" class="btn btn-primary" wire:navigate>Back</a>
            ...
            <div class="container-fluid px-4">
                ...
                <ul class="nav mt-10">
                    <li class="nav-item mr-20 ">
                        <a href="{{ route('getProjects') }}" class="btn btn-dark" wire:navigate>Back</a>
                    </li>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item ms-auto">
                     <button class="btn btn-primary float-right" data-bs-toggle="modal"
                            data-bs-target="#newImage"><i class="fa fa-plus"></i> Add New Images</button>
                ...
                <div class="card mt-5">
                    <div class="card-header bg-dark text-white d-flex align-items-center">
                        <h5 class="mb-0">
                            <span style="color: rgb(173, 114, 35)">{{ $totalImages }}</span> Images
                        </h5>
    ...
    <div class="modal fade" id="newImage">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('addProjectImage',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-lg-6 col-sm-12">
